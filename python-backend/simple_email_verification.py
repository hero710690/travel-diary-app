"""
Simple Email Verification for Travel Diary Backend
All-in-one file without imports to avoid Lambda issues
"""
import json
import os
import boto3
...
def lambda_handler(event, context):
    """Main Lambda handler with email verification"""
    ...
    # Default response for unmatched routes
        ...
        return create_response(200, {
            "message": "Travel Diary API - Email Verification System",
            "version": "2.4.1",
            "endpoints": {
